module.exports = {
  ...
  black_bronze_horn: { id: 'black_bronze_horn', name: 'Black Bronze Horn' },
  ...
  black_crystal_horn: { id: 'black_crystal_horn', name: 'Black Crystal Horn' },
  weathered_arrowhead: {
  ...
  slime_concentrate: { id: 'slime_concentrate', name: 'Slime Concentrate' },
  ...
  fragile_bone_shard: { id: 'fragile_bone_shard', name: 'Fragile Bone Shard' },
  ...
  sturdy_bone_shard: { id: 'sturdy_bone_shard', name: 'Sturdy Bone Shard' },
  ...
  mist_grass_pollen: { id: 'mist_grass_pollen', name: 'Mist Grass Pollen' },
  ...
  recruits_insignia: { id: 'recruits_insignia', name: "Recruit's Insignia" },
  ...
  sergeants_insignia: { id: 'sergeants_insignia', name: "Sergeant's Insignia" },
  relic_from_guyun: {
    id: 'relic_from_guyun',
  ...
  shimmering_nectar: { id: 'shimmering_nectar', name: 'Shimmering Nectar' },
  ...
  philanemo_mushroom: { id: 'philanemo_mushroom', name: 'Philanemo Mushroom' },
  ...
  fungal_spores: { id: 'fungal_spores', name: 'Fungal Spores' },
  luminescent_pollen: { id: 'luminescent_pollen', name: 'Luminescent Pollen' },
  ...
  damaged_prism: { id: 'damaged_prism', name: 'Damaged Prism' },
  turbid_prism: { id: 'turbid_prism', name: 'Turbid Prism' },
  radiant_prism: { id: 'radiant_prism', name: 'Radiant Prism' },
  perpetual_caliber: {
    id: 'perpetual_caliber',
    name: 'Perpetual Caliber',
    rarity: 4,
  },
  padisarah: { id: 'padisarah', name: 'Padisarah' },
  quelled_creeper: {
    id: 'quelled_creeper',
  ...
  puppet_strings: { id: 'puppet_strings', name: 'Puppet Strings' },
  mirror_of_mushin: { id: 'mirror_of_mushin', name: 'Mirror of Mushin' },
  dakas_bell: { id: 'dakas_bell', name: "Daka's Bell" },
  pseudo_stamens: { id: 'pseudo_stamens', name: 'Pseudo-Stamens', rarity: 4 },
  sand_grease_pupa: { id: 'sand_grease_pupa', name: 'Sand Grease Pupa' },
  desiccated_shell: {
    id: 'desiccated_shell',
    name: 'Desiccated Shell',
    rarity: 2,
  },
  sturdy_shell: { id: 'sturdy_shell', name: 'Sturdy Shell', rarity: 3 },
  marked_shell: { id: 'marked_shell', name: 'Marked Shell', rarity: 4 },
  mourning_flower: { id: 'mourning_flower', name: 'Mourning Flower' },
  evergloom_ring: { id: 'evergloom_ring', name: 'Evergloom Ring', rarity: 4 },
  ...
  lumidouce_bell: { id: 'lumidouce_bell', name: 'Lumidouce Bell' },
  ...
  meshing_gear: { id: 'meshing_gear', name: 'Meshing Gear', rarity: 1 },
  rainbow_rose: { id: 'rainbow_rose', name: 'Rainbow Rose' },
  emperors_resolution: {
  ...
  rift_core: { id: 'rift_core', name: 'Rift Core', rarity: 2 },
  foreign_synapse: {
    id: 'foreign_synapse',
  ...
  romaritime_flower: { id: 'romaritime_flower', name: 'Romaritime Flower' },
  fontemer_unihorn: {
    id: 'fontemer_unihorn',
    name: 'Fontemer Unihorn',
    rarity: 4,
  },
  lumitoile: { id: 'lumitoile', name: 'Lumitoile' },
  ...
  subdetection_unit: { id: 'subdetection_unit', name: 'Subdetection Unit' },
  tourbillon_device: {
